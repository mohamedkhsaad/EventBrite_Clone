...
# TEMP: generics view sets mainly for adding objects into the database
...
# check
@api_view(['GET'])
def check_promo_code(request,event_id,promo_code=''):
    ...
    if not Discount.objects.filter(EVENT_ID=event_id,CODE=promo_code).exists():
