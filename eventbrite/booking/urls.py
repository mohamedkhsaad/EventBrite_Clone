...
urlpatterns = [
    ...
    path('events/<int:event_id>/ticket-classes/', list_ticket_classes_by_event, name='list-ticket-classes-by-event'),
    ...
    path('user/<int:user_id>/order-items/',list_orderitem_by_user,name='list-orderitem-by-user')
