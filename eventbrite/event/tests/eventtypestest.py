...
class EventListtypeTest(APITestCase):
    def setUp(self):
        ...
        self.event_type = 'music'

        self.event1 = event.objects.create(
            ID="911", User_id="3", Title="Test Event", organizer="test",
            Description="test", type=self.event_type, Category="test", sub_Category="test", venue_name="test",
    ...
    def test_get_events_by_type(self):
        ...
        """
        url = reverse('event-list-by-type', kwargs={'event_type': self.event_type})
    ...
    def test_get_events_by_non_exist_type(self):
        ...
        """
        nonexistent_type = 'nonexistent type'
        url = reverse('event-list-by-type', kwargs={'event_type': nonexistent_type})
        response = self.client.get(url)
